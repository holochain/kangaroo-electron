...
async function generateIcons() {
  ...
  if (!fs.existsSync(pngPath)) {
    console.warn("WARNING: No icon.png found. If you're using the systray option, an icon.png (1024x1024 pixel) is required  to be provided at the root level of your webhapp's UI assets.");
    return;
  }
